...
int main(int argc, const char * argv[])
{
    ...
    rcl_node = rcl_create_node_wrapper("node_0", "", &init_obj); 
    if ( rcl_node == NULL) {
    ...
    pub = rcl_create_publisher_wrapper(rcl_node, 
    ...
    timer = rcl_create_timer_wrapper(&init_obj,
    ...
    sub = rcl_create_subscription_wrapper(rcl_node, init_obj.allocator,
    ...
    rc = rcl_publisher_fini_wrapper(&init_obj, pub, rcl_node);
    rc = rcl_timer_fini_wrapper(&init_obj, timer);
    rc = rcl_subscription_fini_wrapper(&init_obj, sub, rcl_node);
    init_obj.allocator->deallocate(sub_msg, init_obj.allocator->state);
    free (pub_string);
    rc = rcl_node_fini_wrapper(&init_obj, rcl_node);
